...
public class GenericIronChestBlock extends BlockWithEntity implements Waterloggable {
    ...
    private final Supplier<BlockEntityType<? extends GenericIronChestBlockEntity>> entityTypeRetriever;
    ...
    public GenericIronChestBlock(FabricBlockSettings settings, ExtraChestTypes type, Supplier<BlockEntityType<? extends GenericIronChestBlockEntity>> entityTypeRetriever) {
        super(settings);
    ...
    public DoubleBlockProperties.PropertySource<? extends GenericIronChestBlockEntity> getBlockEntitySource(BlockState state, World world, BlockPos pos, boolean ignoreBlocked) {
        ...
        return DoubleBlockProperties.toPropertySource((BlockEntityType)this.entityTypeRetriever.get(), GenericIronChestBlock::getMergerType, GenericIronChestBlock::getDirectionToAttached, FACING, state, world, pos, biPredicate);
    }
    ...
    public static DoubleBlockProperties.PropertyRetriever<GenericIronChestBlockEntity, Float2FloatFunction> getAnimationProgressRetriever(final ChestAnimationProgress chestAnimationProgress) {
        return new DoubleBlockProperties.PropertyRetriever<GenericIronChestBlockEntity, Float2FloatFunction>() {
