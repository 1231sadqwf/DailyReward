...
import com.kingsley.reward.blocks.GenericIronChestBlock;
...
public class GenericIronChestBlockEntity extends LootableContainerBlockEntity implements ChestAnimationProgress, Tickable {
    ...
    public GenericIronChestBlockEntity(BlockEntityType<? extends GenericIronChestBlockEntity> entity, ExtraChestTypes type) {
        super(entity);
